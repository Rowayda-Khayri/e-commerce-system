...
<form method="POST" action="{{ url('/M$l36opAdmin/order/shipped/'.$orderItems[0]->order_id)}}">
...
<table class="table ">
            ...
            <tr>
             ...
             <tr>
                 <td>
                     <input  type="submit" name="shipped" value="Order is reviewed and shipped" class="btn btn-primary" />
                 </td>
             </tr>
